...
namespace H2910.Base
{
    ...
    public class Audio
    {
        ...
        public Audio(AudioType audioType, AudioClip clip, bool loop, bool persist, float volume, float fadeInValue,
            float fadeOutValue, Transform sourceTransform)
        {
            // Set unique audio ID
        ...
        public void Update()
        {
            ...
            switch (Type)
            {
                case AudioType.Music:
                    {
                        AudioSource.volume = Volume * SoundManager.Instance.GlobalVMusicVolume * SoundManager.Instance.GlobalVolume;
                        break;
                    }

                case AudioType.Sound:
                    {
                        AudioSource.volume = Volume * SoundManager.Instance.GlobalSoundsVolume * SoundManager.Instance.GlobalVolume;
                        break;
                    }

                case AudioType.UISound:
                    {
                        AudioSource.volume = Volume * SoundManager.Instance.GlobalUISoundsVolume * SoundManager.Instance.GlobalVolume;
                        break;
                    }
            }
