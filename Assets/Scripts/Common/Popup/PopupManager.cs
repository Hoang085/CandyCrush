...
namespace H2910.UI.Popups
{
    public class PopupManager : ManualSingletonMono<PopupManager>
    {
        ...
        [SerializeField] private UILoading loadingPanel;
        ...
        public void ShowLoadingScene(string mapName)
        {
            ...
            loadingScreen.LoadScene(mapName);
        }

        public void ShowLoadingIcon(bool isShow, LoadingTypeFX typeFX = LoadingTypeFX.Circle)
        {
            loadingPanel.ShowLoading(isShow,typeFX);
        }
