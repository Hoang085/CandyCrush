    ...
    public class I18NText : MonoBehaviour
    {
        ...
        private void _updateTranslation()
        {
            if (_text)
            {
                ...
                if(!string.IsNullOrEmpty(_key))
                    _text.text = I18N.Instance.getValue(_key, _params) + _tail;
            }
        }
        ...
        public void UpdateParameters(string[] values)
        {
            _params = values;
        }
        ...
        public void SetKey(string key, string tail)
        {
            m_key = key;
            _tail = tail;
            updateTranslation(true);
